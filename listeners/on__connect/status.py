...
class Status(commands.Cog):
    ...
    async def on_connect(self):
        ...
        # await self.bot.change_presence(status=discord.Status.online, activity=discord.CustomActivity(name="You don't deserve me as a bot here, and you don't deserve Snowy here on earth...."))
