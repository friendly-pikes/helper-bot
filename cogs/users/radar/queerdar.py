###############################################
#
# File: cogs.users.radar.queerdar
# Date: 02/03/2026 (EU)
...
class UserCommands__Radar__Queerdar(commands.Cog):
    ...
    async def queerdar(self, ctx: Union[Context, commands.context.Context], user: Union[discord.Member, discord.User]):
        """
        ...
        embed = await SemiFunc.pikesRadar(self.bot, user, "queer")
...
async def setup(bot):
    await bot.add_cog(UserCommands__Radar__Queerdar(bot))
